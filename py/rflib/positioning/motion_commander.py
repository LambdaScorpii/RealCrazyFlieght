...
#  This Source Code is derived from the Motion Commander Class from Bitcraze to be found at: https://github.com/bitcraze/crazyflie-lib-python
"""
...
class MotionCommander:
    ...
    def __init__(
        self,
        rc: RealFlightGenericController,
        default_height: float = 1.5,
    ):
        """
        ...
        self.rc: RealFlightGenericController = rc
    ...
    def take_off(self, height=None, velocity=VELOCITY):
        ...
        self._thread = _SetPointThread(self.rc)
        self._thread.start()
    ...
    def land(self, velocity=VELOCITY):
        ...
        if self._is_flying:
            alt = 1
            while alt > 0.1:
                alt = self.rc.telemetry["Altitude above Ground"].iloc[-1]
                self.down(alt + 1, velocity)
    ...
    def move_distance(
        self, distance_x_m, distance_y_m, distance_z_m, velocity=VELOCITY
    ):
        """
    ...
    def start_linear_motion(
        self, velocity_x_m, velocity_y_m, velocity_z_m, rate_yaw=0.0
    ):
        """
...
class _SetPointThread(Thread):
    ...
    def __init__(self, rc: RealFlightGenericController, update_period=UPDATE_PERIOD):
    ...
    def run(self):
        while True:
            ...
            self.rc.convert_motion_in_channel_values(*event)
    ...
    def _new_setpoint(self, velocity_x, velocity_y, velocity_z, rate_yaw):
        ...
        self._hover_setpoint = [velocity_x, velocity_y, rate_yaw]
